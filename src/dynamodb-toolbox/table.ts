...
const endpointOverride = getStringFromConfig(Constants.DYNAMOCLIENT_ENDPOINT_OVERRIDE);
...
export const DocumentClient = DynamoDBDocumentClient.from(new DynamoDBClient(dynamoDBClientConfig), translateConfig)
